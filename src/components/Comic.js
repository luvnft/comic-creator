        ...
        <div className='p-10'>
            <div className='mb-6 flex justify-center items-center'>
                <form className='flex gap-4 justify-center items-center w-9/12 max-w-4xl flex-col sm:flex-row'>
                    <input type="text" className="w-full sm:w-7/12 px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" value={text} placeholder='Enter prompt here' onChange={(e) => setText(e.target.value)} />
